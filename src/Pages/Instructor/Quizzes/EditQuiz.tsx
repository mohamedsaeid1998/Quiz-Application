...
const EditQuiz = (props) => {
  ...
  const onSubmit = (data) => {};
  console.log("questions_number", quizData?.questions_number);
  return (
    <>
      {loading ? (
        "loading"
            ...
            <div className="  p-4 bg-white border rounded-xl border-stone-400 text-slate-950 text-lg">
              ...
              <>
                ...
                <div className="flex  leading-loose my-2 justify-between rounded-md border border-gray-300 w-80 m-2 text-xl">
                  <div className="bg-orange-100 w-1/3 rounded-sm border pl-5 border-orange-100 ">
                    title
                  </div>
                  <div className="bg-white w-2/3  border-white rounded-md pr-2 pe-2">
                    <input
                      placeholder=""
                      {...register("title", {
