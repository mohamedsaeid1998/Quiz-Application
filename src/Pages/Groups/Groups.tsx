    ...
    <>
      <main>
        <ModalSection
          ...
          handleSubmit={handleSubmit(handleSendData)}
          {...{ openModal, setOpenModal, isLoading }}
        >
          <FormInput
        ...
        <ModalDeleteSection
          ...
          handleFunction={() => deleteGroupData(itemId)}
          {...{ openModalDelete, setOpenModalDelete, isLoading }}
        >
          <p className="font-medium my-3 text-base pt-2 capitalize">
            are you sure you want to delete this Group ? if you are sure just
            click on delete it
          </p>
        </ModalDeleteSection>
        <div className="container">
          ...
          <div className="border p-4 border-[#ddd] rounded-[10px]">
            ...
            <div className="grid grid-cols-2 mt-8 gap-x-12 gap-y-3">
              {groupsData?.map(({ _id, name, max_students }) => (
                <div
                  key={_id}
                  className="border p-4 border-[#ddd] rounded-[10px] flex justify-between items-center"
                >
                  ...
                  <div className=" flex gap-2">
                    ...
                    <button onClick={() => toggleModalDelete(_id)}>
